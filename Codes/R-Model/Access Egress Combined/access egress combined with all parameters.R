...
setwd("G:\\4-2\\CE-400\\Analysis\\R-Model\\Model & Result (Junaid Nusrat)\\Access Egress Combined")
...
apollo_control = list(
  ...
  indivID         = "ID", 
  outputDirectory = "Total_Model_Estimates_combined"
)
# ################################################################# #
...
database = read.csv("G:/4-2/CE-400/Analysis/R-Model/Model & Result (Junaid Nusrat)/Access Egress Combined/Combined_data_S12.csv",header=TRUE)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate") {
  ...
  V[["rick"]] = asc_rick + (b_cost_rick + b_ac_cost_rick*feed) * rick_cost + #b_tt_rick * rick_tt 
                ...
                b_st_moti_rick*(ac_st==16) + b_st_du_rick*(ac_st==14) + b_st_shbg_rick*(ac_st==13) + b_st_karbz_rick*(ac_st==12) + b_st_farm_ricK*(ac_st==11) + 
                b_st_agar_rick*(ac_st==9) + b_st_mir10_rick*(ac_st==6) + b_st_mir11_rick*(ac_st==5) + b_st_pllb_rick*(ac_st==4) + b_st_un_rick*(ac_st==1) +
  ...
  V[["bus"]]  = asc_bus + (b_tt_bus + b_ac_tt_bus*feed) * bus_tt + (b_cost_bus + b_ac_cost_bus*feed) * bus_cost + 
                ...
                b_st_moti_bus*(ac_st==16) + b_st_du_bus*(ac_st==14) + b_st_shbg_bus*(ac_st==13) + b_st_karbz_bus*(ac_st==12) + b_st_farm_bus*(ac_st==11) + 
                b_st_agar_bus*(ac_st==9) + b_st_mir10_bus*(ac_st==6) + b_st_mir11_bus*(ac_st==5) + b_st_pllb_bus*(ac_st==4) + b_st_un_bus*(ac_st==1) +
