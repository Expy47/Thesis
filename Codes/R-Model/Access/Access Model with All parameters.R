...
setwd("G:\\4-2\\CE-400\\Analysis\\R-Model\\Model & Result (Junaid Nusrat)\\Access")
...
apollo_control = list(
  ...
  indivID         = "ID", 
  outputDirectory = "Total_Model_Estimates_Access"
)
...
database = read.csv("G:/4-2/CE-400/Analysis/R-Model/Model & Result (Junaid Nusrat)/Access/ENCODED_ACCESS1+2.csv",header=TRUE)
